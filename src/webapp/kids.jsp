...
<body>
 ...
 <%
        ...
        <section id="product-categories" >
            ...
            <div class="category">
                <a href="./kids_trouser.jsp">
                    <img src="./images/thumbnails/kids_trouser.jpg" alt="kids Trousers">
                    <span>kids Trousers</span>
                </a>
            </div>
            <div class="category">
                <a href="./kids_shirt.jsp">
                    <img src="./images/thumbnails/kids_shirt.jpg" alt="Kids Shirts">
                    <span>kids Shirts</span>
                </a>
            </div>

            <div class="category">
                <a href="./kids_jackets.jsp">
                    <img src="./images/thumbnails/kids_jackets.jpg" alt="kids jacket">

...
<body>
 ...
 <%
        ...
        <section id="product-categories" >
            ...
            <div class="category">
                <a href="./men_trousers.jsp">
                    <img src="./images/thumbnails/men_trouser.jpg" alt="Men Trousers">
                    <span>Men Trousers</span>
                </a>
            </div>
            <div class="category">
                <a href="./men_shirt.jsp">
                    <img src="./images/thumbnails/Men_shirts.jpg" alt="Men Shirts">
                    <span>Men Shirts</span>
                </a>
            </div>

            <div class="category">
                <a href="./men_jacket.jsp">
                    <img src="./images/thumbnails/men_jackets.jpg" alt="Men jacket">
